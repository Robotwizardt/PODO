...
public sealed class StateStore
{
    ...
    public StateStore(string? dataDirectory = null)
    {
        DataDirectory = string.IsNullOrWhiteSpace(dataDirectory)
            ? Path.Combine(AppContext.BaseDirectory, "PaperTodo")
    ...
    public string FilePath => Path.Combine(DataDirectory, "data.json");

    public string BackupPath => Path.Combine(DataDirectory, "data.backup.json");
