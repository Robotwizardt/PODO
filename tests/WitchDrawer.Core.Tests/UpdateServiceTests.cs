...
{
    [Theory]
    [InlineData("https://github.com/Robotwizardt/PODO/releases/download/v1.0.2/app.zip", true)]
    ...
    [InlineData("http://github.com/Robotwizardt/PODO/releases/download/v1.0.2/app.zip", false)]
